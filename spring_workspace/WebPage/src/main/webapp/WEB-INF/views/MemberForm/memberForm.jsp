...
<c:set var="setHome" value="/" />
<c:url var="urlHome" value="/" />
<center>
<h3><font color="red">${msg }</font></h3>
<h3><font color="red">${setHome }</font></h3>
<h3><font color="red">${urlHome}</font></h3>
	<form action="memberProc" method="post">
		<table>
			<tr>
				<td colspan="4" align="center"><hr />필수사항<hr/></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td colspan="3"><input type=radio name='gender' value='n'
					checked="checked" />선택안함 <input type=radio name='gender' value='m' />남자
					<input type=radio name='gender' value='w' />여자</td>
			</tr>
			<tr>
				<td align='center' height=40 colspan=4><input type=submit
					value='로그인' style="width: 120px;" /> <input type=reset value='취소'
